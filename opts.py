...
parser.add_argument('--random_sample', default=False, action="store_true", help='use random sample for video dataset')
parser.add_argument('--dense_length', type=int, default=32, help='Length of frames part while dense sampling')
parser.add_argument('--dense_number', type=int, default=1, help='Number of runs for dense sampling test')


# ========================= Mutual Learning Configs ==========================
parser.add_argument('--rank', default=0, type=int)
parser.add_argument('--world_size', default=1, type=int)
parser.add_argument('--init_method', default='tcp://127.0.0.1:52525', type=str)
